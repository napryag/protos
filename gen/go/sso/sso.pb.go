...
func (x *IsAdminRequsest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminRequsest) ProtoMessage() {}

func (x *IsAdminRequsest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminRequsest.ProtoReflect.Descriptor instead.
func (*IsAdminRequsest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{4}
}

func (x *IsAdminRequsest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\aIsAdmin\x12\x15.auth.IsAdminRequsest\x1a\x15.auth.IsAdminResponseB\x16Z\x14napryag.sso.v1;ssov1b\x06proto3"
